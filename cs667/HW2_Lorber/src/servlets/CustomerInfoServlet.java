...
public class CustomerInfoServlet extends HttpServlet {
	...
	private void showForm(HttpServletRequest request,
		...
		out.println(ServletUtilities.headWithTitle(title) +
				...
				"<TABLE>\n" +
				ServletUtilities.inputElement("Customer ID", "customerID", info.getCustomerID(), true, isPartial) +
				ServletUtilities.inputElement("First name", "firstName", info.getFirstName(), true, isPartial) +
